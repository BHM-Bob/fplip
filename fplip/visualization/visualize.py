...
from fplip.basic.supplemental import start_pymol, select_region
from fplip.visualization.pymol import PyMOLVisualizer
...
def visualize_in_pymol(plcomplex):
    ...
    cmd.read_pdbstr(plcomplex.source_pdb_file_content, f"{pdbid}_orig")
