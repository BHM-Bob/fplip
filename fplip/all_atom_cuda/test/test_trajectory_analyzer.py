"""
All-Atom CUDA Module Trajectory Analyzer Tests
...
class TrajectoryAnalyzerFunctionalTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        converter = PDBConverter(filter_atoms_by_chains(cls.analyzer.u.atoms, ['A', 'B', 'CL']))
        ...
        cls.analyzer.load_waters('SOL')
        cls.analyzer.setup_detector(backend=NumPyBackend())
        cls.analyzer.precompute_detector_once()
