"""
All-Atom-CUDA Module Metal Coordination Tests

Tests for metal coordination detection in the all-atom-cuda module,
...
class AllAtomCUDAMetalCoordinationTest(unittest.TestCase):
    """Test metal coordination detection in all-atom-cuda module."""
