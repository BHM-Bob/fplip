...
HYDROPH_DIST_MAX = 4.1  # Distance cutoff for detection of hydrophobic contacts (extended from 4.0 to reduce false negatives)
HYDROPH_DIST_STRONG = 3.5  # Distance below which hydrophobic contact is classified as strong
...
DETECT_FUSED_RINGS = True  # Enable detection of fused ring systems for pi-stacking interactions
PICATION_DIST_MAX = 6.0  # Max. distance between charged atom and aromatic ring center (Gallivan and Dougherty, 1999)
PICATION_OFFSET_MAX = 1.5  # Pi-cation offset threshold (stricter than pi-stacking, charge must be closer to ring center)
