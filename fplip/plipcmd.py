...
from fplip.basic import config, logger

logger = logger.get_logger()

from fplip.basic.config import __version__
from fplip.basic.parallel import parallel_fn
from fplip.basic.remote import VisualizerData
from fplip.exchange.report import StructureReport
from fplip.exchange.webservices import fetch_pdb
from fplip.structure.preparation import create_folder_if_not_exists, extract_pdbid
from fplip.structure.preparation import tilde_expansion, PDBComplex
...
def process_pdb(pdbfile, outpath, as_string=False, batch_idx=None):
    ...
    if config.PYMOL or config.PICS:
        from fplip.visualization.visualize import visualize_in_pymol
