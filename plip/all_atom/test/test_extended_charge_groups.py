"""
All-Atom Module Extended Charge Group Detection Tests

Tests for extended charge group detection in the all-atom module,
...
class AllAtomExtendedChargeGroupTest(unittest.TestCase):
    """Test extended charge group detection in all-atom module."""
